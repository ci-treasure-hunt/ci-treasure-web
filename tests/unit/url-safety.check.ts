...
check("bare email (must NOT become https://user@host/)", safeExternalUrl("anna@example.com"), null);
check("bare email with subdomain", safeExternalUrl("contactaxisnrw@gmail.com"), null);
