...
Deno.serve(async (req) => {
  ...
  // the internet could post fake "CANCELLED" announcements and rewrite the caption of real
  // channel posts by guessing/reading an event id off the public API. See announce-event/index.ts
