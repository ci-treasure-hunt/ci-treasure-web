---
slug: how-to-find-ci-where-you-live
title: "How to Find Contact Improvisation Near You"
description: "No CI community nearby? How to check properly, join a local scene, and what to do when the nearest jam is a city away or doesn't exist yet."
keywords: ["how to find contact improvisation", "contact improvisation near me", "no contact improvisation near me", "how to get into contact improvisation"]
ogImage: default
...
If you're planning a trip, the [travel guide](/guides/how-to-find-ci-while-traveling) is the one
you want. This one is for a different situation: you live somewhere, you want to dance regularly,
and you're trying to work out whether that's even possible where you are.

The honest answer depends enormously on your city. Some places have had a weekly jam running for
two decades. Most places have nothing at all. Both are normal, and the approach is different for
each.

## How do you find out if there's CI where you live?

Search [CI Treasure Hunt](/) for your city. If nothing comes up, widen to your country, then to the
nearest large city, then to the region. The [full community list](/communities) is worth scanning
...
This is the part that trips people up, and it's worth knowing before you conclude there's nothing
near you.
...
An empty calendar is therefore the normal state, not evidence of a dead scene. A group chat with
nothing posted for a month is usually a quiet season. The way to find out is to message someone,
which is also how you would have found out thirty years ago.

## If there's a scene: how to join it properly

This is where the problem stops being about search and becomes social.

**Show up more than once.** A single visit tells a community almost nothing about you, and it tells
...
Cost is a real barrier, and it's worth knowing that sliding-scale pricing is standard and that many
festivals offer helper or work-exchange places that reduce or waive the fee. The [festival prep
guide](/guides/first-ci-festival-prep) covers what those weeks look like, and how to do one
cheaply.

## Rural areas and small countries

If you're genuinely isolated, distance is the constraint and there's no way around saying so. What
tends to work is inverting the usual order: treat an annual festival or intensive as your main
practice instead of a bonus on top of a local scene, stay in touch between events with the people
you meet there, and be the one who eventually starts something once you know enough others who
want it too.
...
Etiquette](/guides/contact-improvisation-jam-etiquette) · [What Is Contact
Improvisation?](/guides/what-is-contact-improvisation)*
